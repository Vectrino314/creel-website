...
export const LOGO: ImageMetadata = logoIncentitours;

export const ABOUT_IMAGE: ImageMetadata = aboutImage;
export const ABOUT_IMAGE_ALT =
  "Paisaje de la Sierra Tarahumara con viajeros de Incentitours";
...
export const HERO_SLIDES = [
  {
    ...
    image: heroBarrancas,
    alt: "Vista panorámica de las Barrancas del Cobre en la Sierra Tarahumara",
  },
  {
    title: "Tren Chepe Express",
    subtitle: "El viaje más espectacular de México",
    image: heroChepe,
    alt: "Tren Chepe Express recorriendo los cañones de Chihuahua",
  },
  {
    title: "Experiencias culturales",
    subtitle: "Dos países, tres culturas",
    image: heroCultura,
    alt: "Paisaje cultural de la Sierra Tarahumara con formaciones de piedra",
  },
] as const;
...
export const EXPERIENCES = [
  {
    ...
    alt: "Mirador y paisaje de las Barrancas del Cobre",
  },
  {
    eyebrow: "Aventura",
    title: "Tren Chepe Express",
    ...
    alt: "Recorrido del Chepe Express entre bosques y cañones",
  },
  {
    eyebrow: "Cultura",
    title: "Tres culturas",
    ...
    image: heroCultura,
    alt: "Escenario cultural de la Sierra Tarahumara",
  },
] as const;
...
export const DESTINATIONS: Destination[] = [
  {
    ...
    imageAlt:
      "Parque de Aventura Barrancas del Cobre en Divisadero con vistas a los cañones",
  ...
  },
  {
    ...
    imageAlt: "Pueblo Mágico de Creel en la Sierra Tarahumara",
  ...
  },
  {
    ...
    imageAlt: "Ciudad de Chihuahua Capital, punto de partida del Chepe Express",
  ...
  },
  {
    ...
    imageAlt: "Cuauhtémoc, tierra de las tres culturas en Chihuahua",
  ...
  },
  {
    ...
    imageAlt: "Pueblo Mágico de El Fuerte en Sinaloa",
...
export const PACKAGES: Package[] = [
  {
    ...
    imageAlt: "Paquete Barrancas Express con vistas a la Barranca del Cobre",
  ...
  },
  {
    ...
    imageAlt: "Paquete Entre dos Pueblos Mágicos: Creel y El Fuerte",
  ...
  },
  {
    ...
    imageAlt: "Paquete Altura y Aventura a bordo del Chepe Express",
  ...
  },
  {
    ...
    imageAlt: "Paquete Cultural por la Sierra Tarahumara y culturas locales",
  ...
  },
  {
    ...
    imageAlt: "Paquete Espectacular con aventura en Barrancas del Cobre",
  ...
  },
  {
    ...
    imageAlt: "Paquete Maravillosa con Creel, barrancas y El Fuerte",
